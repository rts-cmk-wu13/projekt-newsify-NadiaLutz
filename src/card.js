const STORAGE_KEYS = {
  ...
  export function createArticleCard(title, abstract, url, thumbnail, section, mode = "home") {
    ...
    if (mode === "home") {
        ...
        bookmarkBtn.className = "action-btn bookmark-btn";
        bookmarkBtn.title = "Bookmark";
      
        const bookmarkImg = document.createElement("img");
        bookmarkImg.src = "src/img/feather_bookmark-white.png"; 
        ...
        bookmarkBtn.addEventListener("click", (e) => {
          e.stopPropagation();
          e.preventDefault();
          const idx = bookmarked.indexOf(url);
          if (idx > -1) {
            bookmarked.splice(idx, 1);
            bookmarkImg.src = "src/img/feather_bookmark-white.png"; 
          } else {
            bookmarked.push(url);
            bookmarkImg.src = "src/img/feather_bookmark-filled.png";
          }
